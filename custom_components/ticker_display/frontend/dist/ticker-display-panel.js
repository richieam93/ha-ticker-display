...
(function () {
  ...
  class TickerDisplayPanel extends HTMLElement {
    ...
    async _loadSelectedDevice() {
      ...
      this._directViewportMode = String(device.direct_viewport_mode || "desktop") === "normal" ? "normal" : "desktop";
    ...
    _savePayload(extra = {}) {
      ...
      return {
        ...
        direct_viewport_mode: this._directViewportMode === "normal" ? "normal" : "desktop",
