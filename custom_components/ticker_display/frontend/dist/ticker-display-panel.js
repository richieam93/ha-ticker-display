...
(function () {
  ...
  class TickerDisplayPanel extends HTMLElement {
    ...
    async _loadSelectedDevice() {
      if (!this._selectedId) { this._device = null; this._pages = []; this._renderMode = "wrapper"; this._directUrl = ""; this._directKiosk = true; this._modules = defaultModules(); return; }
