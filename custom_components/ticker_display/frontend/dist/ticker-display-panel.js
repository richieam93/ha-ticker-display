...
(function () {
  ...
  function screenToPage(screen, index = 0) {
    ...
    return {
      ...
      fit_mode: cfg.fit_mode || cfg.fitMode || cfg.viewport_mode || "desktop-fit",
  ...
  function pageToScreen(page, index = 0) {
    ...
    return {
      ...
      fit_mode: page.fit_mode || "desktop-fit",
